...
export declare class APIPromise<T> extends Promise<T> {
    ...
    constructor(client: LlamaAPIClient, responsePromise: Promise<APIResponseProps>, parseResponse?: (client: LlamaAPIClient, props: APIResponseProps) => PromiseOrValue<T>);
