...
export declare namespace CompletionMessage {
    interface ToolCall {
        /**
...
export interface CreateChatCompletionRequest {
     ...
     * response.
     */
    response_format?: CreateChatCompletionRequest.JsonSchemaResponseFormat | CreateChatCompletionRequest.TextResponseFormat;
    /**
...
export declare namespace CreateChatCompletionRequest {
    ...
    namespace JsonSchemaResponseFormat {
        /**
         * The JSON schema the response should conform to.
         */
...
export declare namespace CreateChatCompletionResponseStreamChunk {
    /**
     * The event containing the new content
     */
    interface Event {
...
export declare namespace MessageImageContentItem {
    /**
     * Contains either an image URL or a data URL for a base64 encoded image.
     */
    interface ImageURL {
