...
var _a, _LlamaAPIClient_encoder;
Object.defineProperty(exports, "__esModule", { value: true });
exports.LlamaAPIClient = void 0;
...
const Uploads = __importStar(require("./core/uploads.js"));
...
class LlamaAPIClient {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('LLAMA_API_CLIENT_BASE_URL'), apiKey = (0, env_1.readEnv)('LLAMA_API_KEY'), ...opts } = {}) {
        _LlamaAPIClient_encoder.set(this, void 0);
        this.chat = new API.Chat(this);
        this.models = new API.Models(this);
        this.moderations = new API.Moderations(this);
        if (apiKey === undefined) {
            throw new Errors.LlamaAPIClientError("The LLAMA_API_KEY environment variable is missing or empty; either provide it, or instantiate the LlamaAPIClient client with an apiKey option, like new LlamaAPIClient({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            ...opts,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('LLAMA_API_CLIENT_LOG'), "process.env['LLAMA_API_CLIENT_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        __classPrivateFieldSet(this, _LlamaAPIClient_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.LlamaAPIClientError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return __classPrivateFieldGet(this, _LlamaAPIClient_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.LlamaAPIClient = LlamaAPIClient;
_a = LlamaAPIClient, _LlamaAPIClient_encoder = new WeakMap();
LlamaAPIClient.LlamaAPIClient = _a;
LlamaAPIClient.DEFAULT_TIMEOUT = 60000; // 1 minute
LlamaAPIClient.LlamaAPIClientError = Errors.LlamaAPIClientError;
LlamaAPIClient.APIError = Errors.APIError;
LlamaAPIClient.APIConnectionError = Errors.APIConnectionError;
LlamaAPIClient.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
LlamaAPIClient.APIUserAbortError = Errors.APIUserAbortError;
LlamaAPIClient.NotFoundError = Errors.NotFoundError;
LlamaAPIClient.ConflictError = Errors.ConflictError;
LlamaAPIClient.RateLimitError = Errors.RateLimitError;
LlamaAPIClient.BadRequestError = Errors.BadRequestError;
LlamaAPIClient.AuthenticationError = Errors.AuthenticationError;
LlamaAPIClient.InternalServerError = Errors.InternalServerError;
LlamaAPIClient.PermissionDeniedError = Errors.PermissionDeniedError;
LlamaAPIClient.UnprocessableEntityError = Errors.UnprocessableEntityError;
LlamaAPIClient.toFile = Uploads.toFile;
LlamaAPIClient.Chat = chat_1.Chat;
LlamaAPIClient.Models = models_1.Models;
LlamaAPIClient.Moderations = moderations_1.Moderations;
